...
pub fn buttons() -> Element(a) {
  div([class("p-4 grid grid-cols-7 gap-x-4 gap-y-8  items-center justify-items-center")], [
    ...
    button([button.light(button.Neutral), button.md()], [text("Light Neutral")]),
    button([button.light(button.Primary), button.md()], [text("Light Primary")]),
    button([button.light(button.Secondary), button.md()], [
      text("Light Secondary"),
    ]),
    button([button.light(button.Success), button.md()], [text("Light Success")]),
    button([button.light(button.Info), button.md()], [text("Light Info")]),
    button([button.light(button.Warning), button.md()], [text("Light Warning")]),
    ...
    button([button.ghost(button.Neutral), button.md()], [text("Ghost Neutral")]),
    button([button.ghost(button.Primary), button.md()], [text("Ghost Primary")]),
    button([button.ghost(button.Secondary), button.md()], [
      text("Ghost Secondary"),
    ]),
    button([button.ghost(button.Success), button.md()], [text("Ghost Success")]),
    button([button.ghost(button.Info), button.md()], [text("Ghost Info")]),
    button([button.ghost(button.Warning), button.md()], [text("Ghost Warning")]),
    ...
    button([button.solid(button.Primary), button.md(), attribute.disabled(True)], [text("Disabled")]),
    button([button.solid(button.Primary), button.md(), attribute.disabled(True)], [
